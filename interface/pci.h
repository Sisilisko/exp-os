...
void pci_write_config32(pci_addr addressinfo, uint8_t offset, uint32_t val);
...
pci_t *lookupPCIdevice(PCIdevice *device);
void setupPCIdeviceDriver(pci_t *pci, PCI_DRIVER driver,
                          PCI_DRIVER_CATEGORY category);
